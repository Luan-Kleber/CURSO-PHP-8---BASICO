...
pedido é feito ao servidor (por exemplo para ver uma nova página), toda a informação
sobre variáveis é perdida.
...
passando variaveis através de POST ou GET (veremos em breve como funciona).
